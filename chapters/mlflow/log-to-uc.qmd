# Log R Models to Unity Catalog {#sec-log-to-uc}
...
```{r, eval=FALSE}
mlflow_log_model <- function(model, artifact_path, signature, ...) { # <1>
...
### Registration to Unity Catalog {#sec-log-to-uc-register-to-uc}
