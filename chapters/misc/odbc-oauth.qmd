...
User-to-machine (U2M) is typically what you'd want to use. The Databricks ODBC driver supports OAuth flows, but the minimum driver version differs by flow:

- [OAuth token passthrough / M2M requires `2.7.5` or above](https://docs.databricks.com/en/integrations/odbc/authentication.html#oauth-token-passthrough-authentication)
- [Browser-based OAuth U2M requires `2.8.2` or above](https://docs.databricks.com/en/integrations/odbc/authentication.html#oauth-user-to-machine-u2m-authentication)
